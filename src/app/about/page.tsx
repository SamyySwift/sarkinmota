...
export default function AboutPage() {
  ...
  const heroVideoY = useTransform(scrollYProgress, [0, 0.4], ["0%", "30%"]);
  const heroTextOpacity = useTransform(scrollYProgress, [0, 0.2], [1, 0]);
  const heroTextY = useTransform(scrollYProgress, [0, 0.2], ["0%", "50%"]);

  return (
    <main ref={containerRef} className="relative bg-background text-white selection:bg-accent selection:text-black">
      ...
      <section className="relative h-[100vh] w-full overflow-hidden flex items-center justify-center">
        ...
        >
          ...
          >
            ...
            <p className="max-w-xl mx-auto text-lg md:text-xl text-subtle font-light leading-relaxed">
              Curating the world’s most coveted performance <br className="hidden md:block"/> and luxury machines for those who move differently.
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          <span className="text-[9px] uppercase tracking-widest text-subtle font-bold">Discover</span>
          ...
          <div className="max-w-[1400px] mx-auto w-full">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative z-10 space-y-8 lg:col-span-5 pl-4 lg:pl-0">
                ...
                >
                  A Legacy of <br/><span className="text-accent italic">Uncompromising</span> Standards.
                </motion.h2>
                <motion.div 
                  initial={{ opacity: 0 }}
                ...
                >
                  <p>
                    SarkinMota was not founded simply to move vehicles. It was established to elevate the entire automotive acquisition experience. We believe that true luxury is not just found in the leather or the horsepower, but in the seamless, transparent, and intensely personal journey of finding your perfect machine.
                  </p>
                  <p>
                    Every vehicle in our showroom has been subjected to a rigorous certification process. If a car does not meet our exact standard of mechanical perfection and aesthetic brilliance, it does not earn the SarkinMota badge.
                  </p>
                </motion.div>
              </div>
              ...
              <div className="relative h-[60vh] md:h-[80vh] w-full rounded-[40px] overflow-hidden border border-white/10 lg:col-span-7">
                <StickyImageSwapper scrollY={scrollYProgress} />
      ...
      <section className="relative z-20 bg-black py-32 px-6 border-y border-white/5 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-24">
             <span className="text-accent text-[10px] tracking-[0.3em] uppercase mb-4 block font-bold">The SarkinMota Difference</span>
      ...
      <section className="relative z-20 bg-background py-48 px-6 text-center">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-display">Experience <br/> the <span className="text-accent italic">Difference</span>.</h2>
          <p className="text-xl text-subtle font-light">
            Your next automotive masterpiece awaits in our showroom. Let us assist you in acquiring exactly what you desire.
          </p>
          <div className="pt-8">
            <Link 
              href="/shop"
...
function PillarCard({ icon, title, description, delay }: { icon: React.ReactNode, title: string, description: string, delay: number }) {
  return (
    <motion.div 
      initial={{ opacity: 0, y: 30 }}
      whileInView={{ opacity: 1, y: 0 }}
    ...
    >
      ...
      <h3 className="text-2xl font-display text-white mb-4 group-hover:text-accent transition-colors">{title}</h3>
