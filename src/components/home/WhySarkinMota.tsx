...
export default function WhySarkinMota() {
  ...
  // The negative percentage depends on the number of cards to scroll through.
  // We have 1 title panel + 4 detail panels = 5 panels total.
  // We want to scroll so the last panel aligns with the screen edge.
  // We'll use viewport units directly in the transform for reliable responsiveness.
